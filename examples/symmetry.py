...
# wyckoff_groups_conv = symm.get_wyckoff_groups_conventional()
...
# print("Wyckoff groups of the conventional cell:")
# for i_group, group in enumerate(wyckoff_groups_conv):
    # print("Group {}".format(i_group))
...
# Crystals might have what are so-called free Wyckoff parameters. In this case
# the relative positions of symmetrically equivalent atoms are not fixed, but
# may depend on up to three parameters: x, y, y which are given with respect to
# the conventional cell lattice vectors. With MatID, the presence of these free
# parameters may be queried, and their values resolved.
scaled_positions = [
