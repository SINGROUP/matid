...
MAX_CELL_SIZE = [4, 12]
REL_POS_TOL = [0.30, 0.55, 0.80]  # Position tolerances. Given relative to minimum distance between two atoms in the system.
# REL_POS_TOL = [0.25, 0.5, 0.9]  # Position tolerances. Given relative to minimum distance between two atoms in the system.
