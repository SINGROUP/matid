...
class PeriodicFinder():
    ...
    def _find_periodic_region(self, system, vacuum_dir, tesselation_distance, seed_index, unit_cell, seed_position, periodic_indices):
        ...
        Args:
            system(ASE.Atoms): Original system from which the periodic
                region is searched
            vacuum_dir(sequence of boolesn): The vacuum directions in the
