...
def fetch_continuous_translations():
    """
    Will see which space groups allow continuous translations. These need
    special treatment.
    """
...
if __name__ == "__main__":
    ...
    # Fetch and save transforms
    fetch_continuous_translations()
