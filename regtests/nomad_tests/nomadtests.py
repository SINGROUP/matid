...
class Class2DTests(unittest.TestCase):
    ...
    # def test_28(self):
        ...
        # """
        # system = get_atoms("./fhiaims10/Surface/Ba5Ge13O40+Ba11Ge7O16.json")
        # view(system)
    ...
    # def test_31(self):
        # system = get_atoms("./fhiaims12/Surface/Mg60O62+H2MgNi.json")
        # view(system)
        ...
        # self.assertEqual(set(outliers), set([124, 125, 72]))

    # def test_32(self):
        # system = get_atoms("./fhiaims12/Surface/O24Sr8Ti11+Ti.json")
        # view(system)
    ...
    def test_33(self):
        system = get_atoms("./fhiaims12/Surface/Ba16+O40Si12.json")
        view(system)
